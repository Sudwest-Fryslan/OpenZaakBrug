...
WORKDIR /home
RUN mkdir lib
RUN curl -H "Accept: application/zip" -k https://nexus.ibissource.org/repository/OpenZaakBrugExtensions/nl/sudwestfryslan/translations/ozb-extensions/1.0.1-SNAPSHOT/ozb-extensions-1.0.1-20220217.145849-6.jar > lib/extension.jar
