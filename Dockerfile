...
RUN curl -H "Accept: application/zip" -k https://nexus.frankframework.org/repository/OpenZaakBrugExtensions/nl/sudwestfryslan/translations/ozb-extensions/1.0.1-SNAPSHOT/ozb-extensions-1.0.1-20220822.084521-8.jar > lib/extension.jar
