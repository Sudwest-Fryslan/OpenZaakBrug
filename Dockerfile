...
RUN curl -H "Accept: application/zip" -k https://nexus.frankframework.org/repository/OpenZaakBrugExtensions/nl/sudwestfryslan/translations/ozb-extensions/1.0.2-SNAPSHOT/ozb-extensions-1.0.2-20241126.151320-1.jar > lib/extension.jar
