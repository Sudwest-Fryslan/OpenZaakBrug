...
public class RestTemplateService {
	...
	/*
	 * public HttpHeaders getHeaders() { var headers = new HttpHeaders();
	 * headers.setContentType(MediaType.APPLICATION_JSON); headers.set("Accept-Crs",
	 * "EPSG:4326"); headers.set("Content-Crs", "EPSG:4326");
